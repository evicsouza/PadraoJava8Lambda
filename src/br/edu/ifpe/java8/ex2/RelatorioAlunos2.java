...
public class RelatorioAlunos2 {
	...
	private static final Map<TipoRelatorio2, Function<Aluno, String>> OPERACOES;
	static {
		OPERACOES = new HashMap<>();
		OPERACOES.put(TipoRelatorio2.NOME, aluno->aluno.getNome());
		OPERACOES.put(TipoRelatorio2.NOME_MATRICULA, aluno->aluno.getNome() + SEPARADOR + aluno.getMatricula());
		OPERACOES.put(TipoRelatorio2.NOME_MATRICULA_MEDIA, aluno->aluno.getNome() + SEPARADOR + aluno.getMatricula() + SEPARADOR + aluno.getMedia());
		OPERACOES.put(TipoRelatorio2.NOME_MEDIA, aluno->aluno.getNome() + SEPARADOR + aluno.getMedia());
		OPERACOES.put(TipoRelatorio2.MATRICULA_MEDIA, aluno->aluno.getMatricula() + SEPARADOR + aluno.getMedia());
	}
